...
for i_ch in range(ch_num):
    ...
    savefig(fig, 'example_res_conv_AFD_circle/searching_dictionary_ch_{:n}.jpg'.format(i_ch))
# generate evaluator
afdcal.genEva()
...
for i_ch in range(ch_num):
    ...
    savefig(fig, 'example_res_conv_AFD_circle/evaluator_ch_{:n}.jpg'.format(i_ch))
...
for i_ch in range(ch_num):
    ...
    savefig(fig, 'example_res_conv_AFD_circle/decomp_comp_level_{:n}_ch_{:n}.jpg'.format(0, i_ch))
    fig, _ = afdcal.plot_basis_comp(0, i_ch = i_ch)
    savefig(fig, 'example_res_conv_AFD_circle/basis_comp_level_{:n}_ch_{:n}.jpg'.format(0, i_ch))
    fig, _ = afdcal.plot_remainder(0, i_ch = i_ch)
    savefig(fig, 'example_res_conv_AFD_circle/remainder_level_{:n}_ch_{:n}.jpg'.format(0, i_ch))
...
for level in range(4):
    ...
    for i_ch in range(ch_num):
        ...
        savefig(fig, 'example_res_conv_AFD_circle/decomp_comp_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
        fig, _ = afdcal.plot_basis_comp(afdcal.level, i_ch = i_ch)
        savefig(fig, 'example_res_conv_AFD_circle/basis_comp_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
        fig, _ = afdcal.plot_re_sig(afdcal.level, i_ch = i_ch)
        savefig(fig, 'example_res_conv_AFD_circle/reconstructed_signal_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
        fig, _ = afdcal.plot_energy_rate(afdcal.level, i_ch = i_ch)
        savefig(fig, 'example_res_conv_AFD_circle/energy_convergence_rate_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
        fig, _ = afdcal.plot_searchRes(afdcal.level, i_ch = i_ch)
        savefig(fig, 'example_res_conv_AFD_circle/searching_result_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
        fig, _ = afdcal.plot_remainder(afdcal.level, i_ch = i_ch)
        savefig(fig, 'example_res_conv_AFD_circle/remainder_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
        fig, _ = afdcal.plot_an(afdcal.level, i_ch = i_ch)
        savefig(fig, 'example_res_conv_AFD_circle/an_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))