...
for i_ch in range(ch_num):
    ...
    savefig(fig, 'example_res_POAFD_square/searching_dictionary_ch_{:n}.jpg'.format(i_ch))
# generate evaluator
afdcal.genEva()
...
for i_ch in range(ch_num):
    ...
    savefig(fig, 'example_res_POAFD_square/evaluator_ch_{:n}.jpg'.format(i_ch))
...
for i_ch in range(ch_num):
    ...
    savefig(fig, 'example_res_POAFD_square/decomp_comp_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
    fig, _ = afdcal.plot_basis_comp(afdcal.level, i_ch = i_ch)
    savefig(fig, 'example_res_POAFD_square/basis_comp_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
    fig, _ = afdcal.plot_re_sig(afdcal.level, i_ch = i_ch)
    savefig(fig, 'example_res_POAFD_square/reconstructed_signal_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
    fig, _ = afdcal.plot_energy_rate(afdcal.level, i_ch = i_ch)
    savefig(fig, 'example_res_POAFD_square/energy_convergence_rate_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
    fig, _ = afdcal.plot_searchRes(afdcal.level, i_ch = i_ch)
    savefig(fig, 'example_res_POAFD_square/searching_result_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
    fig, _ = afdcal.plot_remainder(afdcal.level, i_ch = i_ch)
    savefig(fig, 'example_res_POAFD_square/remainder_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
    fig, _ = afdcal.plot_an(afdcal.level, i_ch = i_ch)
    savefig(fig, 'example_res_POAFD_square/an_level_{:n}_ch_{:n}.jpg'.format(afdcal.level, i_ch))
