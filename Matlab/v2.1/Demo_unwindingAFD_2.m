...
for n=1:N
    ...
    afdcal.nextDecomp()
    [~,systemview]=memory;
    if 1-systemview.PhysicalMemory.Available/systemview.PhysicalMemory.Total>=95/100
...
%%
% plot reconstruction signal
afdcal.plot_reSig(afdcal.level);
afdcal_core.plot_reSig(afdcal_core.level);
